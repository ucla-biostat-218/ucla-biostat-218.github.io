...
Use `CohortGeneratorModule` to create a **shareable** JSON specification
...
::: {.callout-important}
## Remainder of course
We will discuss each of other analysis types; they are much more interesting
:::

## Open science results
